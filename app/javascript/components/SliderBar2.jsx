...
import './../../assets/stylesheets/SliderBar2.css';
// import sp500 from './../../assets/stylesheets/sp500.json';
...
class SliderBar2 extends Component {
   constructor(props){
      super(props)
      this.createSlider2 = this.createSlider2.bind(this)
  ...
  createSlider2() {
    ...
    d3.csv("", type, function(error, data) {
        ...
        x.domain(d3.extent(data, function(d) { return 'Jan 2001'; }));
    ...
    // tell it what you're sending in
    function type(d) {
